...
const VisaDetails = () => {
    return (
        <body class="backgraound-color">
    {/* <!-- hearder section strats here --> */}
    <header class="about-us">
        <div class="header-wrapper">
            <div class="header-logo">
                <a href="#"><img alt="image" class="img-fluid" src="assets/image/about-us/global-sky-logo2.svg"/></a>
            </div>
            <div class="main-menu">
                ...
                <ul class="menu-list">
                    ...
                    <li class="menu-item-has-children"><a class="drop-down" href="#">Global Visa</a><i
    ...
    <div class="about-breadcrum-section mb-120">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
    ...
    <!-- Modal --> */}
    <div class="modal fade visa-apply-modal" id="visa-apply-modal" data-bs-backdrop="static" data-bs-keyboard="false"
        tabindex="-1" aria-labelledby="visa-apply-modalLabel" aria-hidden="true">
        <div class="modal-dialog  modal-dialog-centered">
            <div class="modal-content form-wapper">
                <button type="button" class="modal-close" data-bs-dismiss="modal" aria-label="Close"><i
                        class="bi bi-x-circle"></i></button>
                <div class="modal-header">
                    <ul class="visa-form-step" id="progressbar">
                ...
                <div class="modal-body">
                    <form id="msform" class="visa-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <div class="from-wrapper">
                                        ...
                                        <div
                                            class="next-prev-btn d-flex align-items-center justify-content-end flex-wrap gap-3">
                                            <button class="next primary-btn1">Next <i class="bi bi-arrow-right"></i>
                                            </button>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <div class="from-wrapper">
                                        ...
                                        <div
                                            class="next-prev-btn d-flex align-items-center justify-content-end flex-wrap gap-4">
                                            <button class="prev primary-btn1"> <i class="bi bi-arrow-left"></i>
                                                Previous</button>
                                            <button class="next primary-btn1">Next <i class="bi bi-arrow-right"></i>
                                            </button>
                                        </div>
                                ...
                                <div class="col-lg-8">
                                    <div class="from-wrapper">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="image-drop-area mb-25">
                                                    <div class="dropzone dropzone-1 text-center dz-clickable">
                                                        <div class="icon">
                                            ...
                                            <div class="col-md-4">
                                                <div class="image-drop-area mb-25">
                                                    <div class="dropzone dropzone-2 text-center dz-clickable">
                                                        <div class="icon">
                                                            <img src="assets/image/icon/file.svg" alt="" />
                                                        </div>
                                                    </div>
                                            ...
                                            <div
                                                ...
                                                <button class="prev primary-btn1"> <i class="bi bi-arrow-left"></i>
                                                    Previous</button>
                                                <button class=" primary-btn1" type="submit">Submit</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="visa-apply-section mb-50">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="apply-wrap">
                        ...
                        <div class="visa-type-and-aply-form text-center">
                            <h5>Tourist Visa</h5>
                            ...
                            <button class="primary-btn1" data-bs-toggle="modal" data-bs-target="#visa-apply-modal">Apply
                                Now</button>
                        </div>
                    </div>
                </div>
    ...
    <div class="visa-details-section mb-90">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <div class="visa-details-tab">
                        <ul class="nav nav-tabs" id="visaTab" role="tablist">
                        ...
                        <div class="tab-content" id="visaTabContent">
                            <div class="tab-pane fade show active" id="details-tab-pane" role="tabpanel"
                                                    ...
                                                    <div class="accordion-body">
                                                        <div class="single-document">
                                                            ...
                                                            <div class="doc-content">
                                                                ...
                                                                <ul>
                                                                    <li>a. Minimum 6 month's validity </li>
                                ...
                                <div class="single-information-wrap mb-40">
                                    ...
                                    <div class="content">
                                        <div class="content-wrap">
                                            <p>20 to 25 Working Days (Time may vary depending on applicant's profile and
                                                embassy actually processing time)</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="single-information-wrap">
                                    <div class="title">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="document-card">
                                                        <div class="document-image">
                                                            <img class="popup-image" src="assets/image/document-img.png"
                                                                alt="" />
                                                        </div>
