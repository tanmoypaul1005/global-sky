                        ...
                        {isDropdownOpen && (
                            <div className="custom-select-wrap active two no-scroll">
                                <ul className="option-list">
                                    <li className="single-item" onClick={() => selectCountry('Bangladesh')}>
                                        <h6>Bangladesh</h6>
                                    </li>
                                    <li className="single-item" onClick={() => selectCountry('India')}>
                                        <h6>India</h6>
                                    </li>
                                    <li className="single-item" onClick={() => selectCountry('Nepal')}>
                                        <h6>Nepal</h6>
                                    </li>
                                </ul>
                            </div>
